[] spawn
{
	...
	[
		...
		"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
		false,// data for this setting: Boolean
		true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
		{  
			params ["_value"];
			VCM_Debug = _value;
	...
	[
		"VCM_DRIVING", // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
		"CHECKBOX", // setting type
		["Enhanced vehicle obstacle avoidance (Experimental)", "This option may be taxing on performance in situations with large amounts of vehicles in movement."], // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
		"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
		false, // data for this setting: boolean
		true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
		{  
